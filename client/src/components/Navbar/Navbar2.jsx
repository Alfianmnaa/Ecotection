...
export const Navbar2 = () => {
  ...
  const navbarClasses = `w-full absolute top-0 z-50 bg-white text-black ${scrolling ? " shadow-sm sticky top-0" : ""}`;
  const buttonMasuk = "hover:brightness-90 duration-150 w-[95px] h-[51px] px-6 py-4 rounded-[30px] border border-black text-black justify-center items-center gap-2.5 inline-flex";

  const buttonDaftar = "hover:brightness-90 hover:border duration-150 w-[95px] h-[51px] px-6 py-4 bg-greenMain text-white rounded-[30px] justify-center items-center gap-2.5 inline-flex";
  const settingProfile = "text-black 2xl:text-xl text-smallText font-semibold sm:block hidden";
  ...
  return (
    <header className={navbarClasses}>
      <nav className="   2xl:py-6 sm:py-3 py-1 px-2 h-full flex justify-between items-center">
